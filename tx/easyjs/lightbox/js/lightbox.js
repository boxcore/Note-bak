...
var easyLightBox = {
    ...
    showAnim : function( o ){
        if( o.isAnim ){
            overlayElem.css( 'visibility', 'visible' )
                .anim({
                    from : { left : winWidth + 'px' },
                    to : { left : '0px' },
                    easing : 'easeIn',
                    complete : function(){
                        boxElem.css( 'visibility', 'visible' ).fadeIn( 300 );
                    }                
                });
        }
        else{
    ...
    hideAnim : function( o ){
        if( o.isAnim ){
            boxElem.fadeOut( 300, 'swing', function(){
                overlayElem.anim({
                    to : { left : winWidth + 'px' },
                    from : { left : '0px' },
                    easing : 'easeIn',
