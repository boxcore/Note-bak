(function($){  
	...
	$.fn.oSlider = function(options){
		$.fn.oSlider.defaults = {
			...
			liquidLayout: true,			
			autoStart: true,//�Ƿ������Զ�����
			pauseTime:3000,//ÿ�ι���ͣ��ʱ��			
			arrowsNav:true,//�Ƿ���ʾ���Ҽ�ͷ
			arrowsNavHide:false,//�����ƿ���ͷ��ʧ			
			listNav:true,//�Ƿ���ʾ�ײ�Сͼ���б�
			listNavThumbs:false,//�����·��Ƿ���ʾ����ͼ
			listNavThumbName:'_thumb',//��������ͼ������ǰ׺������ͼ��aa.jpg,����ͼ��������Ϊaa_thumb.jpg			
			pauseOnHover: false,//���������ƶ��������Ƿ�ͣ��			
			layers: false
		};
