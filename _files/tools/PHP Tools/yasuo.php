...
//验证密码
$password = "thunje654321";

?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<title>php在线压缩工具-Thunje（www.thunje.com）整理</title>
<style type="text/css">
<!--
body,td{
font-size: 14px;
...
<div style="color:#FF9900">
   <p>转载请注明：本程序由 <a href="http://www.thunje.com/" target="_blank">Thunje</a>整理提供,作者：thunje(<a href="mailto:thunje@gmail.com">thunje@gmail.com</a>).</p>
...
<br>
压缩文件保存到目录: 
<input name="todir" type="text" id="todir" value="__webBak__" size="15"> 
(留空为本目录,必须有写入权限)<br>
压缩文件名称:
<input name="zipname" type="text" id="zipname" value="webBak[2012].zip" size="15">
(.zip)<br>
<br> 
